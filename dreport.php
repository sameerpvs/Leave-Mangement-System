...
<h2 style="color: #1b68ae;">Monthly Report </h2>
<h4>To view Leave Report, select the Month or User Name </h4>
<form method="post" name="Select" action="">
<input type="radio" name="type"  value="month" id="month1" checked="checked" onclick="check()" style="margin-left: -120px;">Month
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<input type ="radio" name="type" value="uname" id="uname1" onclick="recheck()" style="margin-left: 180px;">Username<br>
...
<div id="myModal" class="modal fade" role="dialog"  >
  ...
  <div class="modal-dialog custom-class" style="width: 80%; ">
...
if ($type == "month")
{
	...
	$result = mysqli_query($db,$sql1);
		...
		<tr><th>&nbsp&nbspS.No&nbsp&nbsp</th>
		<th>&nbsp&nbsp&nbsp&nbsp&nbspName&nbsp&nbsp&nbsp&nbsp&nbsp</th>
		<th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDepartment&nbsp&nbsp&nbsp&nbsp&nbsp</th>
		...
		<th>&nbsp&nbsp&nbsp&nbsp&nbspOD&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                ...
                <th>&nbsp&nbspMAL</th>
		<th>&nbsp&nbsp&nbsp&nbsp&nbspLeave Balance</th> 
		</tr></center> ";
...
else if($type =="uname")
{
	...
	{
		$sql = "SELECT * FROM  `status` WHERE  `username` LIKE  '$usern'  ";
...
<div style="color:red;">
<?
                   $msg ="No entries on username $usern";
echo" <center><strong><h4> $msg </h4></strong><center>";
?>
</div>
<?
}
		...
		$sql8 = "SELECT * FROM  `status` WHERE  `username` LIKE  '$usern'";
...
<td>$doa</td>
				...
				<td><center> $status</center></td>  
                               ...
                               <!-- <a href='#' onclick='printInfo(this)' style='margin-left: 650px;'>Print</a></div>-->
			";
			$count++;

		}

		$sql5 = "SELECT * FROM  `logins` WHERE  `username` LIKE  '$usern'";
