...
.navbar-xs { min-height:118px; height: 118px; background-color: #f6f6f6; }
.navbar-xs .navbar-brand{ padding: 0px 12px;font-size: 16px;line-height: 118px; background-color: #f6f6f6;}
.navbar-xs .navbar-nav > li > a {  padding-top: 0px; padding-bottom: 0px; line-height: 118px; background-color: #f6f6f6; }
.well{
    width: 500px;
    color: #003399;
}
...
<!--<div id="left">
<a href="hod.php"> Home </a><br>
<a href="hleave.php">Apply Leave</a>
  <a href="hreport.php">Leave Report</a>
  <a href="hupdate.php">Update Profile</a>
  <a href="hchange.php">Change Password</a></div>-->
<div id="foot">
