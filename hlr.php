...
<br><br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="Submit" style="margin-left: -100px;">
</center>
</form>
<? 
if( $_POST ){
...
$month = $_POST['month'];
	...
	$sql= "SELECT * FROM `status` WHERE MONTH(FDATE) ='$month' and YEAR(FDATE)='$year' and `dept` like '$dept' order by fdate DESC ";
