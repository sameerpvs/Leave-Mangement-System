...
<tr>
<td>
<label>From Date <input type="text" id="fdate" name="fdate" onclick="splcheck()" readonly="readonly" required>
</label>
</td>
<td>
&nbsp&nbsp <label>To Date <input type="text" id="theDate" name="tdate" readonly="readonly" required disabled></label><br></td></tr>
<tr>
<td>
