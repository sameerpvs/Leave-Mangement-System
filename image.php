<?php
include('session.php');
define("MYSQL_CONN_ERROR", "File too large"); 
...
$insert_image="INSERT INTO image_table (date,imagename,image,username) VALUES(curdate(),'$imagename','$imagetmp','$email')";

$result = mysqli_query($db,$insert_image);
...
<center>
<h3 style="color: #1b68ae;"> OD leave Proof </h3>
<div class="well">
