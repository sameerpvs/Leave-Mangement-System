...
if($wl == yes)
{
$status="Workload Confirmation Awaiting";
}
$st = "Pending with HOD";
if ($wl == no)
{
...
<div style=" width:550px; color: #1B68AE; left:0;"><br><br><h3 id="head" style="margin-left: -80px;"><strong>Leave Application</strong> </h3><hr><h5 style="color:red;"><?  echo $error;?></h5></div>
<div class="well">
...
<tr>
<td>
<label>From Date <input type="text" id="fdate"  onclick="splcheck()" name="fdate" required>
</label>
</td>
<td>
&nbsp&nbsp <label>To Date <input type="text" id="theDate" name="tdate" required disabled></label><br></td></tr>
<tr>
<td>
<label>Type of Leave <select name="leave_type" class="form-control">
  <option value="casual leave" >Casual Leave</option>
  <option value="on duty" onmouseup="upload()">On Duty </option>
...
<div class="form-group">
 <label for="workload">Work Load Adjustment : <input type="radio" class="radio"  name="wl" id="yes" onclick="check()" value="yes" checked>Yes <input type="radio" class="radio" name="wl" id="no" onclick="recheck()" value="no">No</label>


<table id="table">
<tr ><td ><input type="text" value="Date" readonly></td><td><input type="text" value="Year/Branch/Section"  readonly></td><td><input type="text" value="Period"  readonly></td><td><input type="text" value="Faculty Name" style="width: 96%;" readonly></td></tr>
<tr><td><input type="text" id="l1" name="d1a" required ></td><td><input type="text" id="l2" name="d1b" required></td><td><input type="text" id="l3" name="d1c" required></td><td>
<select name="f1" id="l4" style="width: 96%;">
 <option value="" selected/>
<?php
$con = mysqli_connect(DB_SERVER,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
$dis = "SELECT name FROM logins order by name";
...
<tr><td><input type="text" id="l5" name="d2a"></td><td><input type="text" id="l6" name="d2b"></td><td><input type="text"  id="l7" name="d2c"></td><td>
<select name="f2" id="l8" style="width: 96%;">
<option value="" selected/>
<?php
$con = mysqli_connect(DB_SERVER,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
$dis = "SELECT name FROM logins order by name";
...
{
$namee = $roww['name'];
echo "<option value=\"$namee\">" . $roww['name'] . "</option>";
}
?>
</select> </td></tr>
<tr><td><input type="text" id="l9" name="d3a"></td><td><input type="text" id="l10" name="d3b"></td><td><input type="text" id="l11" name="d3c"></td><td>
<select name="f3" id="l12" style="width: 96%;">
<option value="" selected/>
<?php
$con = mysqli_connect(DB_SERVER,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
$dis = "SELECT name FROM logins order by name";
...
<tr><td><input type="text" id="l13" name="d4a"></td><td><input type="text" id="l14" name="d4b"></td><td><input type="text" id="l15" name="d4c"></td><td><select name="f4" id="l16" style="width: 96%;">
<option value="" selected/>
<?php
$con = mysqli_connect(DB_SERVER,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
$dis = "SELECT name FROM logins order by name";
